...
if len(organisation) > 0:
    ...
    no_org = "echo Org ID : None >> project_creation.logs"
    os.system(no_org)
if len(organisation) == 0:
...
def project_creation():
    if output == 0:
        ...
        if output2 == 0:
            ...
            input331 = raw_input("Type 'Yes' if you want to disable the Default VPC in " +project_name + "." + " Or press Enter to continue ")
